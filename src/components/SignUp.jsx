      ...
      <div className="auth-container">
        <div className="auth-left">
          ...
          <div className="community-info">
            ...
            <p>Start your wellness journey with comprehensive health resources, fitness programs, and mental health support designed specifically for students.</p>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              <div className="form-group">
                ...
                <p className="form-help-text">
                  Access wellness programs, health resources, and track your progress
                </p>
              </div>
